...
class AnimationTabBarController: UITabBarController {
    ...
    var iconsImageName:[String] = ["tabbar_home", "tabbar_category", "tabbar_shoppingcart", "tabbar_mine"]
    var iconsSelectedImageName:[String] = ["tabbar_home_highlighted", "tabbar_category_highlighted", "tabbar_shoppingcart_highlighted", "tabbar_mine_highlighted"]
...
//            let shopCar = DiscoverTableViewController()
